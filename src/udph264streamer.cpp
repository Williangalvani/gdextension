...
std::string x264enc_factory = "( appsrc name=mysrc is-live=true ! queue leaky=upstream ! videoconvert ! x264enc tune=zerolatency bitrate=10000 ! video/x-h264,profile=high ! rtph264pay name=pay0 pt=96 )";
std::string vtenc_factory = "( appsrc name=mysrc is-live=true ! queue leaky=upstream ! videoconvert ! vtenc_h264_hw bitrate=10000 ! video/x-h264,profile=high ! rtph264pay name=pay0 pt=96 )";
std::string nvh264enc_factory = "( appsrc name=mysrc is-live=true ! queue leaky=upstream ! videoconvert ! nvh264enc bitrate=10000 ! video/x-h264,profile=high ! rtph264pay name=pay0 pt=96 )";
